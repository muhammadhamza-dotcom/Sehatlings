          ...
          <div data-animate className="scroll-stagger grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div className="h-80 w-full rounded-2xl overflow-hidden bg-muted/40">
                <Image src="/Shariq.webp" alt="Shariq Khan" width={640} height={240} className="w-full h-full object-cover" />
              </div>
              <div className="mt-4 flex items-start justify-between">
                <div>
            ...
            >
              <div className="h-80 w-full rounded-2xl overflow-hidden bg-muted/40">
                <Image src="/Hamza5.webp" alt="Rao Muhammad Hamza" width={640} height={240} className="w-full h-full object-cover" />
              </div>
              <div className="mt-4 flex items-start justify-between">
                <div>
